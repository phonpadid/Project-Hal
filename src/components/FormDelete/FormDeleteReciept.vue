<template >
    <form action="customer">
        <!-- Name -->
       <div>
        <h2 class="text_delete">Delete This Reciepts?</h2><br>
        <h3 class="text_delete_customer">Are you delete this Reciepts?</h3>
       </div>
        </form>
      <!-- Button -->
      <a-button
        v-if="props.mode === 'delete' "
        class="btn-ok border-box h-12 w-32 text-center my-10 mx-9 max-w-xl"
        type="primary"
        danger
        >Ok</a-button
      >
